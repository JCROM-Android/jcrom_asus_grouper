...
cp -a ${SRC_SYSTEM}/app/BrowserProviderProxy.apk ${DST_SYSTEM}/app/BrowserProviderProxy/BrowserProviderProxy.apk
cp -a ${SRC_SYSTEM}/app/CalendarGoogle.apk ${DST_SYSTEM}/app/CalendarGoogle/CalendarGoogle.apk
cp -a ${SRC_SYSTEM}/app/DeskClockGoogle.apk ${DST_SYSTEM}/app/DeskClockGoogle/DeskClockGoogle.apk
...
cp -a ${SRC_SYSTEM}/app/LatinImeDictionaryPack.apk ${DST_SYSTEM}/app/LatinImeDictionaryPack/LatinImeDictionaryPack.apk
...
cp -a ${SRC_SYSTEM}/app/TagGoogle.apk ${DST_SYSTEM}/app/TagGoogle/TagGoogle.apk
...
cp -a ${SRC_ORIG_SYSTEM}/app/GoogleEarth.apk ${DST_SYSTEM}/app/GoogleEarth/GoogleEarth.apk
cp -a ${SRC_ORIG_SYSTEM}/app/GooglePinyinIME.apk ${DST_SYSTEM}/app/GooglePinyinIME/GooglePinyinIME.apk
cp -a ${SRC_ORIG_SYSTEM}/app/KoreanIME.apk ${DST_SYSTEM}/app/KoreanIME/KoreanIME.apk
...
cp -a ${SRC_ORIG_SYSTEM}/app/Thinkfree.apk ${DST_SYSTEM}/app/Thinkfree/Thinkfree.apk
cp -a ${SRC_ORIG_SYSTEM}/app/Videos.apk ${DST_SYSTEM}/app/Videos/Videos.apk
cp -a ${SRC_ORIG_SYSTEM}/app/Wallet.apk ${DST_SYSTEM}/app/Wallet/Wallet.apk
cp -a ${SRC_ORIG_SYSTEM}/app/iWnnIME.apk ${DST_SYSTEM}/app/iWnnIME/iWnnIME.apk
cp -a ${SRC_ORIG_SYSTEM}/app/iWnnIME_Kbd_White.apk ${DST_SYSTEM}/app/iWnnIME_Kbd_White/iWnnIME_Kbd_White.apk
